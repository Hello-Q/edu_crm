...
class Clue(BaseModel):
    ...
    intended_course = models.ForeignKey('edu_admin.Course', related_name='clue_intended_course', verbose_name='意向课程', help_text='意向课程', on_delete=models.DO_NOTHING, null=True, blank=True)
    intended_school = models.ForeignKey('sys_set.Department', related_name='clue_intended_school', verbose_name='意向校区', help_text='意向校区', on_delete=models.DO_NOTHING, null=True, blank=True)
    follow_up_people = models.ForeignKey('sys_set.UserProfile', related_name='clue_follow_up_people', verbose_name='跟进人', help_text='跟进人', on_delete=models.DO_NOTHING, null=True, blank=True)
    ...
    plan_school = models.ForeignKey('sys_set.Department', related_name='clue_plan_school', verbose_name='安排校区', help_text='安排校区', on_delete=True, null=True, blank=True)
    plan_reception = models.ForeignKey('sys_set.UserProfile', related_name='clue_plan_reception', verbose_name='安排接待', help_text='安排接待', on_delete=models.DO_NOTHING, null=True, blank=True)
    plan_teacher = models.ForeignKey('edu_admin.Teacher', related_name='clue_plan_teacher', verbose_name='安排老师', help_text='安排校区', on_delete=models.DO_NOTHING, null=True, blank=True)
    plan_course = models.ForeignKey('edu_admin.Course', related_name='clue_plan_course', verbose_name='安排课程', help_text='安排课程', on_delete=models.DO_NOTHING, null=True, blank=True)
    creator = models.ForeignKey('sys_set.UserProfile', related_name='clue_creator', on_delete=models.DO_NOTHING, verbose_name='创建人', null=True, blank=True)
    operator = models.ForeignKey('sys_set.UserProfile', related_name='clue_operator', on_delete=models.DO_NOTHING, verbose_name='更新人', null=True, blank=True)
